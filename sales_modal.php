<!-- Sales Details -->
<div class="modal fade" id="details<?php echo $row['pr_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $sql="select * from purchase_detail left join product on product.pid=purchase_detail.pid where pr_id='".$row['pr_id']."'";
